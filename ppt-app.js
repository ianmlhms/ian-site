...
import { createDeckGeneration } from "./ppt-ai.js?v=12";
import { fillDeckImages } from "./ppt-images.js?v=11";
import { exportPptx } from "./ppt-export-pptx.js?v=10";
import { exportPdf } from "./ppt-export-pdf.js?v=10";
import { exportCuesDocx, exportScriptDocx } from "./ppt-export-docx.js?v=11";
import { startPresenting } from "./ppt-present.js?v=10";
import { listDecks, loadDeck, saveDeck, deleteDeck, startNewDeck, scheduleAutosave } from "./ppt-store.js?v=12";
import { createHistory } from "./ppt-history.js?v=3";
import { createEditor } from "./ppt-editor.js?v=11";
import { createInspector } from "./ppt-inspector.js?v=6";
import { createAiActions } from "./ppt-ai-actions-ui.js?v=11";
