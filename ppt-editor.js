...
import { moveSlide, insertSlide, duplicateSlide, deleteSlide, updateSlide, setDeckMeta } from "./ppt-deck-ops.js?v=13";
import { reconcilePhotoCredits } from "./ppt-images.js?v=14";
import { openImagePicker } from "./ppt-image-picker.js?v=14";
