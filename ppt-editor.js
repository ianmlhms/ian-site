...
import { moveSlide, insertSlide, duplicateSlide, deleteSlide, updateSlide, setDeckMeta } from "./ppt-deck-ops.js?v=11";
import { reconcilePhotoCredits } from "./ppt-images.js?v=12";
import { openImagePicker } from "./ppt-image-picker.js?v=12";
