...
{ id: "camp", topic: "scouten", name: { lb: "Camp", de: "Lager", en: "Camp" }, clues: [
      { q: { lb: "Firwat gräift een e Zelt ni un d'Bannenzelt wann et reent?", de: "Warum berührt man bei Regen nie das Innenzelt?", en: "Why should you never touch the inner tent when it rains?" },
        a: { lb: "Well d'Waasser dann duerchzitt", de: "Weil das Wasser dann durchzieht", en: "Because water then wicks through" } },
      { q: { lb: "Wat leet een ënnert de Schlofsak fir waarm ze bleiwen?", de: "Was legt man unter den Schlafsack, um warm zu bleiben?", en: "What goes under your sleeping bag to keep you warm?" },
      ...
      { q: { lb: "Wat muss ëmmer bei engem Lagerfeier stoen?", de: "Was muss bei einem Lagerfeuer immer bereitstehen?", en: "What must always be next to a campfire?" },
        a: { lb: "Waasser oder Sand fir ze läschen", de: "Wasser oder Sand zum Löschen", en: "Water or sand to put it out" } },
      { q: { lb: "Firwat baut een en Zelt net an enger Mulde op?", de: "Warum baut man ein Zelt nicht in einer Mulde auf?", en: "Why not pitch a tent in a hollow?" },
...
{ id: "firstaid", topic: "scouten", name: { lb: "Éischt Hëllef", de: "Erste Hilfe", en: "First aid" }, clues: [
      ...
      { q: { lb: "Wéi laang killt een eng Verbrennung mat Waasser?", de: "Wie lange kühlt man eine Verbrennung mit Wasser?", en: "How long do you cool a burn with water?" },
      ...
      { q: { lb: "A wéi eng Positioun leet een een deen ouni Bewosstsinn ass awer otemt?", de: "In welche Lage bringt man eine bewusstlose Person, die atmet?", en: "What position for someone unconscious but breathing?" },
        a: { lb: "Stabil Säitelag", de: "Stabile Seitenlage", en: "The recovery position" } },
      { q: { lb: "Wat kontrolléiert een als éischt bei engem Onfall?", de: "Was prüft man bei einem Unfall zuerst?", en: "What do you check first at an accident?" },
        a: { lb: "Ob et fir dech selwer sécher ass", de: "Ob es für dich selbst sicher ist", en: "Whether the scene is safe for you" } },
      { q: { lb: "Wat mécht een bei staarkem Bluten un engem Aarm?", de: "Was tut man bei starker Blutung am Arm?", en: "What do you do for heavy bleeding on an arm?" },
...
{ id: "luxtoday", topic: "letzebuerg", name: { lb: "Haut", de: "Heute", en: "Today" }, clues: [
      ...
      { q: { lb: "Wéi heeschen déi markéierte Rondwanderweeër am Land?", de: "Wie heißen die markierten Rundwanderwege?", en: "What are the marked circular walks called?" },
...
{ id: "maths", topic: "alldag", name: { lb: "Mathematik", de: "Mathematik", en: "Maths" }, clues: [
  ...
  { q: { lb: "Wéi heeschen Zuelen déi nëmmen duerch 1 a sech selwer deelbar sinn?", de: "Wie heißen Zahlen, die nur durch 1 und sich selbst teilbar sind?", en: "What are numbers divisible only by 1 and themselves called?" },
