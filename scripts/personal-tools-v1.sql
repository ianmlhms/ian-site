...
create policy countdowns_own on public.countdowns for all to authenticated using (user_id = auth.uid());
...
create policy health_days_own on public.health_days for all to authenticated using (user_id = auth.uid());
...
create policy workouts_own on public.workouts for all to authenticated using (user_id = auth.uid());
...
create policy finance_tx_own on public.finance_tx for all to authenticated using (user_id = auth.uid());
...
create policy subscriptions_own on public.subscriptions for all to authenticated using (user_id = auth.uid());
...
create policy user_integrations_own on public.user_integrations for all to authenticated using (user_id = auth.uid());
