...
export const SHOWCASE_ORDER = Object.freeze([
  "games", "duo", "transit", "sky", "chat", "buddy", "wuertspill", "trails", "maps",
]);
...
export const COPY = Object.freeze({
  friends: {
    ...
    cards: {
      ...
      buddy:      { t: "Study Buddy",             s: "Frot stellen, Äntwert kritt — och mat engem Foto vun der Aufgab." },
  ...
  adults: {
    ...
    cards: {
      ...
      transit:    { t: "Bus & Zuch",          s: "Bus, Zuch an Tram fir de ganze Land, mat Linnesich a ganzer Streck.",
                    how: "Routing iwwer MOTIS (transitous), Departen iwwer HAFAS vum Verkéiersbond, Haltestellen aus dem offizielle GTFS." },
      sky:        { t: "SkyLens",             s: "All Fliger ronderëm Nidderaanwen op enger Kaart, live.",
      ...
      buddy:      { t: "Study Buddy",         s: "En Assistent fir Hausaufgaben, Tester a Resuméen — Text a Fotoen.",
...
export const TOUR = Object.freeze({
  ...
  steps: Object.freeze([
    ...
    { id: "buddy",      t: "Study Buddy",         n: "En Assistent fir Hausaufgaben an Tester. Du kanns och e Foto vun der Aufgab schécken. Och dës Äntwert ass eng Demo." },
...
export const UI = Object.freeze({
  ...
  lineSearch: "Linn sichen — z.B. D02",  // placeholder for the line search box
  lineDirection: "Richtung",
  tripDetail: "Klick op e Wee fir all Haltestellen",
  photoSent: "Foto vun der Aufgab",      // caption on the sent-image bubble
  chooser: {
    title: "ian.lu · Demoen",
